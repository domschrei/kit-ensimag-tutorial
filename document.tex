...
\begin{document}
  ...
  Wer sich ein Fahrrad leihen möchte, ist hier gut aufgehoben. Für 72€ (Stand 09/19) kann man sich für ein Jahr in Grenoble ein Fahrrad leihen. Alles funktioniert sehr ähnlich zu \textit{Swapfiets} in Karlsruhe.
	...
	\subsection{Izly}
  Mit Hilfe von Izly kann man mit seiner Studierendenkarte bei Waschsalons, Unirestraurants und Automaten bezahlen. Aufgeladen kann das Konto über eine App beispielsweise mittels Carde Bancaire oder Kreditkarte werden. \todo{Aktivierung}


  \section{Allgemeines}
  \subsection{CVA card}
  reduktionen bei KFETs und ähnlichem \todo{exakt?}
  \subsection{U-Glisse}
