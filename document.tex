...
\begin{document}
  ...
  Eine konkrete Option als Student des INP ist die Société Générale, eine der größten Banken in Frankreich, weil diese ein spezielles vergünstigendes Programm für diese Studenten anbietet (Stand 09/19). Das Angebot hängt jedoch meist von der konkreten Agentur ab. Am Besten vor Eröffnung nochmal beim Integrations-Team nachfragen.
  ...
  Es gibt relativ viele verschiedene Möglichkeiten an der Uni essen zu gehen. Nennenswerte Orte sind CROUS-Restaurants wie das \textit{Intermezzo} und allgemeine Shops für Sandwiches oder Pizza am Tram-Stop \textit{Bibliothèques Universitaires} oder auf dem Campus verteilt. Auch direkt im ENSIMAG kann man sich Essen vorbestellen und dann einfach mittags in einem Raum abholen.
    ...
    Im Allgemeinen macht es keinen großen Unterschied ob man MOSIG oder CySec wählt. Es sei nur erwähnt, dass CySec doch recht anspruchsvoll ist, wenn man wenig mathematische Erfahrung hat. Wenn man Sicherheit am KIT gehört hat (und ein wenig mit C umgehen kann), sollte das jedoch kein Problem sein. Außerdem ist die Anzahl Kurse pro Woche in CySec höher als bei den MOSIG Spezialisierungen. Wenn man jedoch Interesse an dem Gebiet hat sollte es machbar sein. Einfach die Spezialisierung wählen die einem am Meisten zusagt!
